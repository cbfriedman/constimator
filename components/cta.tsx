  ...
  return (
    <section>
      <div className="mx-auto max-w-6xl px-4 pb-20 sm:px-6 lg:px-8 lg:pb-28">
        <div className="rounded-3xl bg-secondary px-6 py-16 text-center text-secondary-foreground glow-panel sm:px-12">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-pretty text-secondary-foreground/70">
