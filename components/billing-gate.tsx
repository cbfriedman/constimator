...
// still needs to see its own dashboard, manage its project list, and
// reach /billing to actually subscribe. Everything else inside the
...
const EXEMPT_PATHS = new Set(["/dashboard", "/projects", "/projects/new", "/billing"])
